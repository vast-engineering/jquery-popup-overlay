		...
		_initonce: function (el) {
			...
			if (options.scrolllock) {
				...
				if (typeof scrollbarwidth === 'undefined') {
					parent = $('<div style="width:50px;height:50px;overflow:auto"><div/></div>').appendTo(options.scrollparent);
					...
					if (options.scrolllock) {
						setTimeout(function () {
							...
							if (options.scrollparenthidecss && options.scrollparenthidecss !== "") {
								$scrollParent.css(options.scrollparenthidecss);
							}
